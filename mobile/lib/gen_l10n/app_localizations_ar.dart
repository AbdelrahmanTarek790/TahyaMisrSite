...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get comprehensiveManagement => 'هيئة شبابية تابعه لوزارة الشباب والرياضة، تجمع بين مختلف التوجهات الشبابية تحت مظلة واحدة وتسعى إلى حل قضايا وتحديات حيوية تواجه المجتمع المصري، خاصة الشباب، اعتمادًا على رؤية شبابية متجددة لتعزيز تنمية الوطن والتقدم به نحو آفاق أفضل.';
