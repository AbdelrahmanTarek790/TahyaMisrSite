...
abstract class NewsRepository {
  ...
  Future<Either<Failure, NewsModel>> createNews({required String title, required String content, required String imagePath});
  Future<Either<Failure, NewsModel>> updateNews({required String newsId,required String title, required String content,String? imagePath,});

  Future<Either<Failure,void>> deleteNews({required String newsId});
}
...
class NewsRepositoryImpl implements NewsRepository {
  ...
  @override
  Future<Either<Failure, NewsModel>> createNews({
  ...
  @override
  Future<Either<Failure, NewsModel>> updateNews({
  ...
  @override
  Future<Either<Failure, void>> deleteNews({required String newsId}) async {
    if (await networkInfo.isConnected) {
      try {
