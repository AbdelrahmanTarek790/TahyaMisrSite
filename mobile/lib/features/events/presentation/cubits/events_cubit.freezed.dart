...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({required final List<EventModel> events})
      : _events = events;
...
abstract class _Loaded implements EventsState {
  const factory _Loaded({required final List<EventModel> events}) =
      _$LoadedImpl;
...
abstract class _$$LoadedDetailsImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({EventModel eventDetails});
}

/// @nodoc
class __$$LoadedDetailsImplCopyWithImpl<$Res>
    extends _$EventsStateCopyWithImpl<$Res, _$LoadedDetailsImpl>
...
class _$LoadedDetailsImpl implements _LoadedDetails {
  const _$LoadedDetailsImpl({required this.eventDetails});
  ...
  @override
  String toString() {
    return 'EventsState.loadedDetails(eventDetails: $eventDetails)';
  }
...
abstract class _LoadedDetails implements EventsState {
  const factory _LoadedDetails({required final EventModel eventDetails}) =
      _$LoadedDetailsImpl;

  EventModel get eventDetails;
  @JsonKey(ignore: true)
  _$$LoadedDetailsImplCopyWith<_$LoadedDetailsImpl> get copyWith =>
      throw _privateConstructorUsedError;
}
...
abstract class _$$EventCreatedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({EventModel newEvent});
}

/// @nodoc
class __$$EventCreatedImplCopyWithImpl<$Res>
    extends _$EventsStateCopyWithImpl<$Res, _$EventCreatedImpl>
...
class _$EventCreatedImpl implements _EventCreated {
  const _$EventCreatedImpl({required this.newEvent});
  ...
  @override
  String toString() {
    return 'EventsState.eventCreated(newEvent: $newEvent)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, newEvent);
...
abstract class _EventCreated implements EventsState {
  const factory _EventCreated({required final EventModel newEvent}) =
      _$EventCreatedImpl;
