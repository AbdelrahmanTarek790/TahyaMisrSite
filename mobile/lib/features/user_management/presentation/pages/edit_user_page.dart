...
import 'package:tahya_misr_app/features/user_management/data/models/user_management_model.dart';
...
class EditUserPage extends StatefulWidget {
  ...
  const EditUserPage({super.key, required this.user, required this.id});
...
/*
  ...
  void _saveProfile() {
    if (_formKey.currentState!.validate()) {
      ...
      context.read<UserManagementCubit>().updateUser(widget.id,data);
    }
  }
}
