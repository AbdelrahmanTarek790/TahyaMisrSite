...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(UserModel user, String token) authenticated,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(UserModel user, String token)? authenticated,
...
class _$AuthenticatedImpl implements Authenticated {
  const _$AuthenticatedImpl({required this.user, required this.token});
...
abstract class Authenticated implements AuthState {
  const factory Authenticated(
      ...
      required final String token}) = _$AuthenticatedImpl;
