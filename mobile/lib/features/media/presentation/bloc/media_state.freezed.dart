...
mixin _$MediaState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Media> media) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Media> media)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({required final List<Media> media}) : _media = media;
...
abstract class _Loaded implements MediaState {
  const factory _Loaded({required final List<Media> media}) = _$LoadedImpl;
