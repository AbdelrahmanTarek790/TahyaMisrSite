        ...
        body: BlocListener<JoinRequestCubit, JoinRequestState>(
          listener: (context, state) {
            state.when(
              ...
              detailLoaded: (_) {},
              actionCompleted: (joinRequest, action) {
                toastification.show(
                  context: context,
                  type: ToastificationType.success,
                  style: ToastificationStyle.flat,
                  title: Text(action == 'approved' ? 'تم قبول الطلب' : 'تم رفض الطلب'),
                  description: Text('تم ${action == 'approved' ? 'قبول' : 'رفض'} طلب ${joinRequest.name}'),
