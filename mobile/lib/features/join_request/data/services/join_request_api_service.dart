...
class JoinRequestApiService {
  ...
  Future<JoinRequestModel> createJoinRequest(JoinRequestCreateRequest request) async {
    try {
      print('Creating join request with: ${request.toJson()}');
  ...
  Future<JoinRequestResponse> getJoinRequests({
    ...
    try {
      print('Getting join requests with page: $page, limit: $limit, status: $status');
  ...
  Future<JoinRequestModel> approveJoinRequest(String id, JoinRequestActionRequest request) async {
    try {
  ...
  Future<JoinRequestModel> denyJoinRequest(String id, JoinRequestActionRequest request) async {
    try {
