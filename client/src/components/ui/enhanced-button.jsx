  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        hero: "bg-[linear-gradient(135deg,_rgb(179,29,29),_rgb(255,215,0))] text-egypt-white border-0 hover:shadow-glow hover:scale-105 font-semibold",
        cta: "bg-egypt-gold text-egypt-black hover:bg-egypt-gold/90 hover:shadow-elegant font-semibold",
        "outline-hero": "border-2 border-egypt-gold text-egypt-gold bg-transparent hover:bg-egypt-gold hover:text-egypt-black",
      },
      size: {
