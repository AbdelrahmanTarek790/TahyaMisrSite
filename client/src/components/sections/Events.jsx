        ...
        try {
            ...
            if (response.ok) {
                ...
                const transformedEvents = eventsData.map((item, index) => ({
                    ...
                    price: "Free",
                    featured: index === 0,
                    image: item.image ? `https://form.codepeak.software/uploads/${item.image}` : "https://images.unsplash.com/photo-1515187029135-18ee286d815b?w=600&h=400&fit=crop"
                }));
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-4">
                                            <div className="flex items-center space-x-2 text-muted-foreground">
                                                ...
                                                <span className="font-semibold">{events[0].attendees} registered</span>
                                            </div>
                                        </div>
                            ...
                            {events.slice(1).map((event, index) => (
                                ...
                                >
                                    ...
                                    <CardContent className="p-6">
                                        ...
                                        <p className="text-muted-foreground mb-4 leading-relaxed">{event.description.length > 120 ? event.description.substring(0, 120) + "..." : event.description}</p>
