...
import api, { heroImagesAPI, siteSettingsAPI } from "@/app/api/api"
    ...
    useEffect(() => {
        ...
        const loadData = async () => {
            await heroImagesAPI
                .getAll()
                .then((res) => {
                    const uploadsBase = "https://tmbackend.tahyamisryu.com/uploads/"
                ...
                <SimpleInViewStagger className="max-w-4xl mx-auto" staggerDelay={0.2}>
                    ...
                    <div className="mt-12 grid grid-cols-3 gap-8 max-w-3xl mx-auto hero-stats">
                        <div className="text-center stagger-item">
                            <div className="text-3xl font-bold text-egypt-gold mb-2 animate-float">{siteSettings?.activeMembers}</div>
                        ...
                        <div className="text-center stagger-item">
                            <div className="text-3xl font-bold text-egypt-gold mb-2 animate-float">1000+</div>
