                ...
                <Card className="w-full max-w-2xl text-center">
                    <CardContent className="p-12">
                        ...
                        <p className="text-lg text-muted-foreground mb-8">
                            شكرًا لك على اهتمامك بالانضمام إلى اتحاد شباب تحيا مصر. 
                            سيقوم فريقنا بمراجعة طلبك والرد عليك خلال 5 أيام عمل.
                        </p>
                        ...
                        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
                            <Card className="text-center">
                                <CardContent className="p-8">
                                    ...
                                    <p className="text-muted-foreground">
                                        ستحصل على بريد تأكيد خلال 24 ساعة
                                    </p>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="text-center">
                                <CardContent className="p-8">
                                    ...
                                    <p className="text-muted-foreground">
                                        فريق متخصص يراجع كل طلب بعناية
                                    </p>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="text-center">
                                <CardContent className="p-8">
                                    ...
                                    <p className="text-muted-foreground">
                                        رد نهائي خلال 5 أيام عمل كحد أقصى
                                    </p>
                                </CardContent>
                            </Card>
                        </div>
