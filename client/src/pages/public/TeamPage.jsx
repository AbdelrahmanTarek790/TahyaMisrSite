...
const TeamPage = () => {
    ...
    const seoData = getPageSEO("team", "ar")
    ...
    const boardMembers = [
        ...
        // },
        {
            ...
            social: {
                email: "vice.chairman@tahyamisr.org",
                linkedin: "#",
                facebook: "#",
            },
        },
        ...
        },
        {
            ...
            social: {
                email: "admin.head@tahyamisr.org",
                linkedin: "#",
                facebook: "#",
            },
        },
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">
                            تعرف علي أعضاء مجلس الإدارة الذين يقودون اتحاد شباب تحيا مصر نحو تحقيق رؤيتنا في بناء جيل شبابي قادر على قيادة المستقبل
                        </p>
                    ...
                    <div className="flex justify-center mb-12">
                        <Card className="group  transition-all duration-500 hover:-translate-y-2 lg:w-[32%] bg-white border-0 shadow-card overflow-hidden">
                            <div className="relative">
                                <div className="h-64 bg-gradient-to-br from-egypt-red/10 to-egypt-gold/10 flex items-center justify-center">
                                    {/* <User className="w-24 h-24 text-egypt-red/30" /> */}
                                    <img src={image1} alt="مصطفى أشرف نعمان عبدالجابر قطامش" className=" w-full h-full " />
                                </div>
