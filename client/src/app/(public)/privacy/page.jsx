...
export const metadata = {
    title: "سياسة الخصوصية - اتحاد شباب تحيا مصر | Privacy Policy",
    description: "اطلع على سياسة الخصوصية وحماية البيانات في اتحاد شباب تحيا مصر. نلتزم بحماية خصوصيتك وبياناتك الشخصية بأعلى معايير الأمان",
    keywords: "سياسة الخصوصية, حماية البيانات, خصوصية, أمان المعلومات, privacy policy, data protection, اتحاد شباب تحيا مصر",
    openGraph: {
        title: "سياسة الخصوصية - اتحاد شباب تحيا مصر",
        description: "حماية خصوصيتك أولويتنا القصوى",
        url: "https://tahyamisryu.com/privacy",
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "سياسة الخصوصية - اتحاد شباب تحيا مصر",
            },
        ],
        locale: "ar_EG",
        type: "website",
    ...
    twitter: {
        ...
        title: "سياسة الخصوصية - اتحاد شباب تحيا مصر",
        description: "التزامنا بحماية بياناتك الشخصية",
        images: ["https://tahyamisryu.com/Logo.webp"],
    },
    alternates: {
        canonical: "https://tahyamisryu.com/privacy",
    },
}
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "@type": "WebPage",
                        name: "سياسة الخصوصية - اتحاد شباب تحيا مصر",
                        description: "سياسة حماية الخصوصية والبيانات الشخصية",
                        url: "https://tahyamisryu.com/privacy",
                        inLanguage: "ar",
                        isPartOf: {
                            "@type": "WebSite",
                ...
                <section className="py-20 bg-[linear-gradient(135deg,_rgb(179,29,29),_rgb(255,215,0))] text-white">
                    <div className="container mx-auto px-6 text-center">
                        <div className="max-w-4xl mx-auto">
                            ...
                            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight font-arabic">سياسة الخصوصية</h1>
                            ...
                            <div className="flex items-center justify-center gap-2 text-lg">
                                ...
                                <span className="font-arabic">آخر تحديث: سبتمبر 2025</span>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container mx-auto px-6">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                                نؤمن بحقك في الخصوصية ونلتزم بأعلى معايير حماية البيانات
                            </p>
                        </div>
