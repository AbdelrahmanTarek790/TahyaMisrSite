...
export const metadata = {
    title: "فريق العمل - اتحاد شباب تحيا مصر | مجلس الإدارة والقيادات",
    description: "تعرف على فريق عمل اتحاد شباب تحيا مصر، مجلس الإدارة، والقيادات الشبابية الملهمة التي تقود الاتحاد نحو تحقيق أهدافه",
    keywords: "فريق العمل, مجلس الإدارة, قيادات الاتحاد, أعضاء الاتحاد, الفريق التنفيذي, اتحاد شباب تحيا مصر",
    openGraph: {
        title: "فريق العمل - اتحاد شباب تحيا مصر",
        description: "قيادات شبابية ملهمة تعمل على خدمة الشباب المصري وبناء المستقبل",
        url: "https://tahyamisryu.com/team",
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "فريق عمل اتحاد شباب تحيا مصر",
            },
        ],
        locale: "ar_EG",
        type: "website",
    ...
    twitter: {
        ...
        title: "فريق العمل - اتحاد شباب تحيا مصر",
        description: "تعرف على القيادات الشبابية الملهمة في الاتحاد",
        images: ["https://tahyamisryu.com/Logo.webp"],
    },
    alternates: {
        canonical: "https://tahyamisryu.com/team",
    },
}
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "@type": "AboutPage",
                        name: "فريق العمل - اتحاد شباب تحيا مصر",
                        description: "مجلس الإدارة والقيادات الشبابية في اتحاد شباب تحيا مصر",
                        url: "https://tahyamisryu.com/team",
                        mainEntity: {
                            "@type": "Organization",
                            ...
                            <Card className="group  transition-all duration-500 hover:-translate-y-2 lg:w-[32%] bg-white border-0 shadow-card overflow-hidden">
                                <div className="relative">
                                    <div className="h-64  flex items-center justify-center">
                                        ...
                                        <Image src={image1} alt="مصطفى أشرف نعمان عبدالجابر قطامش" className=" w-full h-full object-contain " />
                                    </div>
                            ...
                            {boardMembers.map((member) => (
                                ...
                                >
                                    <div className="relative">
                                        <div className="h-64  flex items-center justify-center">
                                            {/* <User className="w-24 h-24 text-egypt-red/30" /> */}
                                            <Image src={member.image} alt={member.name} className="w-full h-full object-contain" />
                                        </div>
