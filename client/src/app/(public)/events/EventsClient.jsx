...
export default function EventsClient({ initialEvents, initialTotal }) {
    ...
    const fetchEvents = async () => {
        try {
            ...
            let url = `https://tmbackend.tahyamisryu.com/api/v1/events?page=${pagination.page}&limit=${pagination.limit}`
            if (searchTerm.trim()) {
                    ...
                    <div className="mb-12 animate-fade-in">
                        <div className="relative max-w-md mx-auto">
                            ...
                            <Input
                                ...
                                className="pr-12 pl-12 h-12 border-2 border-egypt-gold/20 focus:border-egypt-gold rounded-xl text-right font-arabic"
                            />
                            {searchTerm && (
                                <button
                                    onClick={() => {
