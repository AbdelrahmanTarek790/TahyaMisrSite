...
export const metadata = {
    title: "عن اتحاد شباب تحيا مصر - رؤيتنا ورسالتنا",
    description:
        "تعرف على اتحاد شباب تحيا مصر، رؤيتنا لبناء جيل شبابي مُلهم، رسالتنا في إعداد كوادر شبابية واعية، وقيمنا الأساسية في خدمة المجتمع والوطن",
    keywords: "اتحاد شباب تحيا مصر, عن الاتحاد, رؤية الاتحاد, رسالة الاتحاد, قيم شبابية, تمكين الشباب, الشباب المصري, القيادة الشبابية",
    openGraph: {
        title: "عن اتحاد شباب تحيا مصر - رؤيتنا ورسالتنا",
        description: "اتحاد شبابي مصري يجمع مختلف التوجهات الشبابية تحت مظلة واحدة لخدمة الوطن وبناء المستقبل",
        url: "https://tahyamisryu.com/about",
    ...
    twitter: {
        ...
        title: "عن اتحاد شباب تحيا مصر",
        description: "تعرف على رؤيتنا ورسالتنا في بناء جيل شبابي مُلهم يخدم الوطن",
        images: ["https://tahyamisryu.com/Logo.webp"],
    },
    alternates: {
        canonical: "https://tahyamisryu.com/about",
    },
}
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        description: "اتحاد شبابي مصري يجمع مختلف التوجهات الشبابية تحت مظلة واحدة لخدمة الوطن",
                        foundingDate: "2018",
                        address: {
                            "@type": "PostalAddress",
                        ...
                        sameAs: ["https://facebook.com/tahyamisryu", "https://twitter.com/tahyamisryu", "https://instagram.com/tahyamisryu"],
                        mission: "العمل على إعداد كوادر شبابية واعية وقادرة من خلال تعزيز قيم العمل التطوعي والمجتمعي",
                    }),
                }}
            />
