...
export const metadata = {
    title: "الأسئلة الشائعة - اتحاد شباب تحيا مصر | FAQ",
    description: "إجابات شاملة على أكثر الأسئلة شيوعًا حول العضوية، الفعاليات، الأمان، والخدمات في اتحاد شباب تحيا مصر",
    keywords: "أسئلة شائعة, FAQ, استفسارات, مساعدة, دعم, العضوية, الفعاليات, اتحاد شباب تحيا مصر",
    openGraph: {
        title: "الأسئلة الشائعة - اتحاد شباب تحيا مصر",
        description: "جميع الإجابات على أسئلتك حول خدمات وأنشطة الاتحاد",
        url: "https://tahyamisryu.com/faq",
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "أسئلة شائعة - اتحاد شباب تحيا مصر",
            },
        ],
        locale: "ar_EG",
        type: "website",
    ...
    twitter: {
        ...
        title: "الأسئلة الشائعة - اتحاد شباب تحيا مصر",
        description: "إجابات على جميع استفساراتك",
        images: ["https://tahyamisryu.com/Logo.webp"],
    },
    alternates: {
        canonical: "https://tahyamisryu.com/faq",
    },
};
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "@type": "FAQPage",
                        name: "الأسئلة الشائعة - اتحاد شباب تحيا مصر",
                        description: "إجابات على الأسئلة الشائعة حول اتحاد شباب تحيا مصر",
                        url: "https://tahyamisryu.com/faq",
                ...
                <section className="py-20 bg-[linear-gradient(135deg,_rgb(179,29,29),_rgb(255,215,0))] text-white">
                    <div className="container mx-auto px-6 text-center">
                        <div className="max-w-4xl mx-auto">
                            ...
                            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight font-arabic">الأسئلة الشائعة</h1>
