...
export const metadata = {
    title: "شروط الخدمة - اتحاد شباب تحيا مصر | Terms of Service",
    description: "اطلع على شروط وأحكام استخدام خدمات اتحاد شباب تحيا مصر. القواعد والشروط التي تحكم العضوية والمشاركة في أنشطة الاتحاد",
    keywords: "شروط الخدمة, شروط الاستخدام, terms of service, قواعد العضوية, أحكام, اتحاد شباب تحيا مصر",
    openGraph: {
        title: "شروط الخدمة - اتحاد شباب تحيا مصر",
        description: "القواعد والشروط التي تحكم استخدامك لخدماتنا",
        url: "https://tahyamisryu.com/terms",
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "شروط الخدمة - اتحاد شباب تحيا مصر",
            },
        ],
        locale: "ar_EG",
        type: "website",
    ...
    twitter: {
        ...
        title: "شروط الخدمة - اتحاد شباب تحيا مصر",
        description: "الشروط والأحكام الخاصة بخدماتنا",
        images: ["https://tahyamisryu.com/Logo.webp"],
    },
    alternates: {
        canonical: "https://tahyamisryu.com/terms",
    },
}
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "@type": "WebPage",
                        name: "شروط الخدمة - اتحاد شباب تحيا مصر",
                        description: "شروط وأحكام استخدام خدمات اتحاد شباب تحيا مصر",
                        url: "https://tahyamisryu.com/terms",
                        inLanguage: "ar",
                        isPartOf: {
                            "@type": "WebSite",
                ...
                <section className="py-20 bg-[linear-gradient(135deg,_rgb(179,29,29),_rgb(255,215,0))] text-white">
                    <div className="container mx-auto px-6 text-center">
                        <div className="max-w-4xl mx-auto">
                            ...
                            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight font-arabic">شروط الخدمة</h1>
                            ...
                            <div className="flex items-center justify-center gap-2 text-lg">
                                ...
                                <span className="font-arabic">سارية المفعول من: سبتمبر 2025</span>
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="max-w-4xl mx-auto space-y-8">
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4 text-muted-foreground text-right leading-relaxed">
                                    <p>
                                        باستخدامك لمنصة اتحاد شباب تحيا مصر أو المشاركة في أنشطتنا، فإنك توافق على الالتزام بهذه الشروط والأحكام. إذا
                                        كنت لا توافق على أي جزء من هذه الشروط، يرجى عدم استخدام خدماتنا.
                                    </p>
                                    <p>
                                        نحتفظ بالحق في تعديل هذه الشروط في أي وقت، وسيتم إشعارك بأي تغييرات جوهرية قبل دخولها حيز التنفيذ بفترة
                                        معقولة.
                                    </p>
                                </CardContent>
                            </Card>
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4 text-muted-foreground text-right leading-relaxed">
                                    <p>
                                        <strong>شروط العضوية:</strong> يجب أن تكون مصري الجنسية وتتراوح أعمارك بين 18-35 عامًا للانضمام كعضو كامل.
                                        الأعضاء تحت سن 18 يحتاجون موافقة ولي الأمر.
                                    </p>
                                    <p>
                                        <strong>دقة المعلومات:</strong> أنت مسؤول عن ضمان صحة ودقة جميع المعلومات المقدمة في ملفك الشخصي. أي معلومات
                                        كاذبة قد تؤدي إلى إنهاء العضوية.
                                    </p>
                                    <p>
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4 text-muted-foreground text-right leading-relaxed">
                                    <p>
                                        <strong>الإنهاء الطوعي:</strong> يمكنك إنهاء عضويتك في أي وقت عبر إرسال طلب كتابي لإدارة الاتحاد. سيتم حذف
                                        حسابك خلال 30 يومًا من تاريخ الطلب.
                                    </p>
                                    <p>
                                        <strong>الإنهاء من قبل الاتحاد:</strong> نحتفظ بالحق في إنهاء العضوية في حالة مخالفة هذه الشروط أو السلوك
                                        المضر بسمعة الاتحاد أو أعضائه.
                                    </p>
                                    <p>
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4 text-muted-foreground text-right leading-relaxed">
                                    <p>
                                        اتحاد شباب تحيا مصر يقدم خدماته "كما هي" دون ضمانات صريحة أو ضمنية. نحن نبذل قصارى جهدنا لتقديم خدمة عالية
                                        الجودة ولكن لا نضمن عدم انقطاع الخدمة أو خلوها من الأخطاء.
                                    </p>
                                    <p>
