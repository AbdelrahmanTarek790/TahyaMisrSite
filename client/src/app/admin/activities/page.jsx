...
import { activitiesAPI } from "@/app/api/api"
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                {imagePreview && (
                                    <div className="mt-2">
                                        <img
                                            src={imagePreview.startsWith("/") ? `https://tmbackend.tahyamisryu.com${imagePreview}` : imagePreview}
                                            alt="Preview"
                        ...
                        <CardContent>
                            {activity.image && (
                                <div className="mb-4 aspect-video bg-gray-100 rounded-lg overflow-hidden">
                                    <img
                                        src={activity.image.startsWith("/") ? `https://tmbackend.tahyamisryu.com${activity.image}` : activity.image}
                                        alt={activity.title}
