...
import { positionsAPI } from "@/app/api/api"
...
const PositionsManagement = () => {
    ...
    }, [filters.page, filters.search, filters.isActive, filters.isGlobal, filters.limit])
    ...
    const fetchPositions = async () => {
        try {
            ...
            if (filters.isGlobal !== "all") {
                params.isGlobal = filters.isGlobal === "global"
            }
                    ...
                    <div className="flex flex-col md:flex-row gap-4">
                        ...
                        <div className="flex gap-2">
                            ...
                            <select
                                ...
                                onChange={(e) => setFilters((prev) => ({ ...prev, isGlobal: e.target.value, page: 1 }))}
                                className="px-3 py-2 border border-gray-300 rounded-md"
                            >
