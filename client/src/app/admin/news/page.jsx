...
import { newsAPI } from "@/app/api/api"
...
const NewsManagement = () => {
    ...
    return (
        <div className="space-y-6">
                            ...
                            <CardHeader>
                                <div className="flex justify-between items-start">
                                    <div>
                                        ...
                                        <CardDescription>Published on {new Date(newsItem.createdAt).toLocaleDateString()}</CardDescription>
                                    </div>
            ...
            <CreateNewsSheet isOpen={isSheetOpen} onClose={handleSheetClose} onSuccess={handleSheetSuccess} editingNews={editingNews} />
        </div>
    )
}
